						...
						<div className="col-sm-7">
								...
								<div className="video-gallery text-center">
									<Link to="#">
										<div className="iframe-img">
											<img src={window.location.origin + '/frontend/images/home/iframe1.png'} alt="" />
										</div>
							...
							<div className="col-sm-3">
								<div className="video-gallery text-center">
									<Link to="#">
										<div className="iframe-img">
											<img src={window.location.origin + '/frontend/images/home/iframe2.png'} alt="" />
										</div>
										<div className="overlay-icon">
											<i className="fa fa-play-circle-o"></i>
										</div>
							...
							<div className="col-sm-3">
								<div className="video-gallery text-center">
									<Link to="#">
										<div className="iframe-img">
											<img src={window.location.origin + '/frontend/images/home/iframe3.png'} alt="" />
										</div>
										<div className="overlay-icon">
											<i className="fa fa-play-circle-o"></i>
										</div>
							...
							<div className="col-sm-3">
								<div className="video-gallery text-center">
									<Link to="#">
										<div className="iframe-img">
											<img src={window.location.origin + '/frontend/images/home/iframe4.png'} alt="" />
										</div>
										<div className="overlay-icon">
											<i className="fa fa-play-circle-o"></i>
										</div>
